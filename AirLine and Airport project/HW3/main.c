...
int initManagerAndAirline(AirportManager* pManager, Airline* pCompany,const char* ailineFileName, int compressIndictor)
{
		...
		if (res == FROM_FILE)
			return initAirlineFromFile(pCompany, pManager, ailineFileName,compressIndictor);
		else
